...
base_model = 'dlo_x3_2048'

# Note: dataset to use is determined by base_model
dataset_available = ["ModelNet40", "ScanNetSeg", "ShapeNetParts", "dlo_dataset"]
dataset_to_path = {
    "ModelNet40": {
    ...
    "dlo_dataset": {
        "train": "F:\wire_hareness_dataset\data\labels\set2",
        "test": "F:\wire_hareness_dataset\data\labels\set2"
    }
}

base_model_available = ['modelnet_x3_l4', 'scannet_x8_2048_k8_fps', 'shapenet_x8_2048_fps', 'dlo_x3_2048']

base_model_to_dataset = {
    "modelnet_x3_l4": "ModelNet40",
    "shapenet_x8_2048_fps": "ShapeNetParts",
    "dlo_x3_2048": "dlo_dataset"
}
